---
title: "Structure vased drug design"
...
Here we download and clean up the HIV-Pr strucure(PDB code: 1HSG) from the main PDB database. We will make a seperate set of "protein-only" and "ligand only" PDB files.
